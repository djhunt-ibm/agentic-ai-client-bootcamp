...
14. Enter Deployment name and select “Deployment Space”. Then click on “Deploy”.(If there are no deployment space you need to create one using  [this](#/assets/deployment_space_creation.md) guide.)
